---
title: ARisk-Based Real-Time Motion Planning Fusing Injury-Knowledge and Probability Assessment into Human Safety
authors:
  - name: Xin Ma
    url: https://roman.technology
    institution: Munich Institute of Robotics and Machine Intelligence (MIRMI), Technical University of Munich (TUM) 
    notes: ["*"]
  - name: Alessandro Melone
    institution: Munich Institute of Robotics and Machine Intelligence (MIRMI), Technical University of Munich (TUM)
    notes: ["*"]
  - name: Riddhiman Laha
    institution: Munich Institute of Robotics and Machine Intelligence (MIRMI), Technical University of Munich (TUM), Northeastern University
  - name: Robin Jeanne Kirschner
    institution: Munich Institute of Robotics and Machine Intelligence (MIRMI), Technical University of Munich (TUM), TUM Hospital, Department for Orthopaedics and Sportsorthopaedics
  - name: Riccardo Bonalli
    institution: Laboratoire des Signaux et Syst\`emes, Université Paris-Saclay, CNRS, CentraleSupélec
  - name: Luis Figueredo
    institution: School of Computer Science at The University of Nottingham
  - name: Sami Haddadin
